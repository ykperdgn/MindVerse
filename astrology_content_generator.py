...
class AdvancedAstrologyGenerator:
    def __init__(self):
        ...
        self.content_templates = {
            "daily": {
                ...
                "themes": [
                    ...
                    "Cesaret ve Güç", "Duygusal Denge", "Yaratıcı İlham", "İçsel Huzur"
                ]
            },
            "weekly": {
                "title_formats": [
                ...
                "themes": [
                    ...
                    "Güçlü Enerji Akışı", "Aşkın Büyüsü", "İçsel Keşif"
                ]
            },
            "monthly": {
                "title_formats": [
                ...
                "themes": [
                    ...
                    "Kozmik Enerji", "Yaşam Dönüşümü", "Ruhsal Evrim"
                ]
            }
        }
        ...
        self.astrological_aspects = {
            "planets": {
                ...
                "Venüs": ["aşk", "güzellik", "sanat", "uyum", "romantizm", "diplomasi"],
                "Merkür": ["iletişim", "zeka", "teknoloji", "ticaret", "yazma", "öğrenme"],
                "Jüpiter": ["şans", "genişleme", "felsefe", "yurtdışı", "bereket", "bilgelik"],
                "Satürn": ["disiplin", "sorumluluk", "test", "olgunluk", "sabır", "kararlılık"],
                "Uranüs": ["değişim", "özgürlük", "teknoloji", "devrim", "yaratıcılık", "sürpriz"],
                "Neptün": ["rüyalar", "sanat", "spiritüalite", "illüzyon", "sezgi", "empati"],
                "Plüton": ["dönüşüm", "güç", "gizem", "yeniden doğuş", "derin değişim", "güçlenme"]
            },
            "advice_categories": {
                "love": ["romantik", "ilişki", "aşk", "sevgi", "uyum", "bağlılık"],
                "career": ["kariyer", "iş", "para", "başarı", "proje", "yatırım"],
                "health": ["sağlık", "enerji", "dinlenme", "spor", "beslenme", "denge"],
                "spiritual": ["ruhsal", "meditasyon", "spiritüel", "iç gelişim", "sezgi", "bilinç"]
            },
            "moon_phases": {
                "new_moon": "Yeni Ay'ın etkisi ile yeni başlangıçlar yapma zamanı",
                "waxing_moon": "Artan Ay'ın gücü ile hedeflerinizi büyütebilirsiniz",
                "full_moon": "Dolunay'ın etkisi ile duygularınız yoğunlaşacak",
                "waning_moon": "Azalan Ay'ın etkisi ile bırakma ve temizlenme zamanı"
            }
        }
    ...
    def _generate_detailed_content(self, sign_data: Dict, period: str, theme: str) -> str:
        ...
        # Ay faz etkisi
        moon_phase = random.choice(list(self.astrological_aspects["moon_phases"].values()))
